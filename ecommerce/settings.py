...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "http://chiara-aqmarina-ecommerceapp.pbp.cs.ui.ac.id", "https://chiara-aqmarina-ecommerceapp.pbp.cs.ui.ac.id"]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Ensure this directory includes your templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
